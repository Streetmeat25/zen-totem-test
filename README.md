## Запуск
Помимо **npm start** необходимо еще установить и запустить json-server(использую как моковое api)
`npm run server` 

Для логина в приложение создано два пользователя
Логин: test
Пароль; test
...
Для добавления новых, открыть db.json и добавить.
